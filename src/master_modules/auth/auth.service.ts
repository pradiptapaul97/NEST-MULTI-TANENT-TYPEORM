...
import { UserRepository } from 'src/master_modules/user/repository/user.repository';
import { JwtService } from '@nestjs/jwt';
import { ConfigService } from '@nestjs/config';
import { RefreshTokenRepository } from 'src/master_modules/refresh-token/repository/refresh-token.repository';
...
export class AuthService {
    ...
    async loginAdmin(loginDto: LoginDto) {
        ...
        const userData = await this.userRepository.getByField({
